Public Class print50
    ...
    Sub printdailysales()
        ...
        Try
            ...
            sql.CommandText = "SELECT * FROM vw_payment50report WHERE isPaid = 1 AND (tDate BETWEEN ('" & fromdate & "')AND('" & ToDate & "')) ORDER BY transno DESC"
            da.SelectCommand = sql
            da.Fill(dt, "vw_payment50report")
