...
insert  into `temp_transaction`(`transId`,`transdetailsId`,`totalstockId`,`qty`,`totalprice`,`ornum`,`empID`,`status`) values (36,0,15,1,0.00,'',0,0);
...
insert  into `transaction_details2`(`transdetailsId`,`amountTendered`,`Discount`,`delfee`,`totaDueAmount`,`currentBal`,`tDate`,`transNo`,`chequeNo`,`chequeamount`,`credamount`,`clientid`,`numberofitems`,`isPaid`) values (1,25000.00,10,2500.00,47880.00,25380.00,'20221115','202211150001',0,'0','0',202206160005,4,0),(2,12000.00,5,1000.00,22800.00,11800.00,'20221115','202211150002',0,'0','0',202206160007,1,0),(3,0.00,5,5000.00,51205.00,45705.00,'20221117','202211170003',0,'0','5500',202206160006,5,0),(4,0.00,5,5000.00,33250.00,26750.00,'20221117','202211170004',0,'0','6500',202206160004,1,0),(5,0.00,5,5000.00,9215.00,6715.00,'20221117','202211170005',0,'0','7500',202206160004,1,0);
...
/*!50001 CREATE TABLE  `vwctransaction2`(
 ...
 `tDate` varchar(50) ,
 `chequeNo` bigint(20) ,
 `chequeamount` varchar(155) ,
 `credamount` varchar(155) ,
 `isPaid` int(12) 
)*/;
