...
insert  into `stocks`(`stockid`,`itemid`,`quantity`) values (1,1,5),(2,2,25),(3,3,8),(4,4,18),(5,5,8),(6,6,7),(7,7,8),(8,8,0),(9,9,0),(10,10,0),(11,11,0),(12,12,0),(13,13,0),(14,14,31),(15,15,9),(16,16,0),(17,17,7),(18,18,0),(19,19,14),(20,20,2),(21,21,0),(22,22,45),(23,23,20),(24,24,23),(25,25,0),(26,26,23),(27,27,13),(28,28,12),(29,29,16),(30,30,15),(31,31,16),(32,32,1),(33,33,0),(34,34,1),(35,35,19),(36,36,14),(37,37,4),(38,38,31),(39,39,17),(40,40,4),(41,41,14),(42,42,17),(43,43,0),(44,44,11),(45,45,29),(46,46,1),(47,47,5),(48,48,7),(49,49,17),(50,50,1),(51,51,1),(52,52,19),(53,53,13),(54,54,5),(55,55,39),(56,56,15),(57,57,42),(58,58,11),(59,59,31),(60,60,3),(61,61,25),(62,62,2),(63,63,25),(64,64,0),(65,65,0),(66,65,0),(67,67,0),(68,68,0);
...
insert  into `transaction`(`transId`,`transdetailsId`,`totalstockId`,`qty`,`totalprice`,`ornum`,`clientID`,`numberofitems`,`empID`) values (1,1,8,1,12000.00,'202211150001',20220614001,3,0),(2,1,5,1,9500.00,'202211150001',20220614001,3,0),(3,1,23,1,9100.00,'202211150001',20220614001,3,0),(4,2,4,1,6900.00,'202211150002',202210060010,2,0),(5,2,7,1,24000.00,'202211150002',202210060010,2,0),(6,3,33,1,15000.00,'202211170003',202210060010,1,0),(7,4,15,1,4600.00,'202211170004',202210060010,1,0),(8,5,15,1,4600.00,'202211170005',202210060010,1,0),(9,6,4,1,6900.00,'202211170006',202210060010,1,0),(10,7,7,1,24000.00,'202211170007',202210060010,1,0),(11,8,5,1,9500.00,'202211170008',202210060010,1,0),(12,9,14,1,9700.00,'202211200009',202210060010,2,0),(13,9,2,1,7500.00,'202211200009',202210060010,2,0),(14,10,19,1,8800.00,'202211200010',202210060010,1,0);
...
insert  into `transaction_details`(`transdetailsId`,`amountTendered`,`Discount`,`delfee`,`totaDueAmount`,`amountChange`,`tDate`,`transNo`,`chequeNo`,`chequeamount`,`credamount`,`clientid`,`numberofitems`,`noi`) values (1,31600.00,5,2500.00,31570.00,30.00,'20221115','202211150001',0,0.00,0.00,20220614001,0,3),(2,31400.00,5,2000.00,31355.00,45.00,'20221115','202211150002',0,0.00,0.00,202210060010,0,2),(3,0.00,5,500.00,14750.00,0.00,'20221117','202211170003',4234234,14.00,0.00,202210060010,0,1),(4,0.00,5,5000.00,9370.00,0.00,'20221117','202211170004',41231,9370.00,0.00,202210060010,0,1),(5,0.00,5,500.00,4870.00,0.00,'20221117','202211170005',0,0.00,3870.00,202210060010,0,1),(6,0.00,5,500.00,7055.00,0.00,'20221117','202211170006',555555,7044.00,0.00,202210060010,0,1),(7,0.00,5,500.00,23300.00,0.00,'20221117','202211170007',44444,23300.00,0.00,202210060010,0,1),(8,0.00,5,500.00,9525.00,0.00,'20221117','202211170008',0,0.00,9525.00,202210060010,0,1),(9,16800.00,6,600.00,16768.00,32.00,'2022-11-20','202211200009',0,0.00,0.00,202210060010,0,2),(10,8900.00,5,500.00,8860.00,40.00,'2022-11-20','202211200010',0,0.00,0.00,202210060010,0,1);
...
insert  into `transaction_details2`(`transdetailsId`,`amountTendered`,`Discount`,`delfee`,`totaDueAmount`,`currentBal`,`tDate`,`transNo`,`chequeNo`,`chequeamount`,`credamount`,`clientid`,`numberofitems`,`isPaid`) values (1,25000.00,10,2500.00,47880.00,25380.00,'20221115','202211150001',0,0.00,0.00,202206160005,4,0),(2,12000.00,5,1000.00,22800.00,11800.00,'20221115','202211150002',0,0.00,0.00,202206160007,1,0),(3,0.00,5,5000.00,51205.00,45705.00,'20221117','202211170003',0,0.00,5500.00,202206160006,5,0),(4,0.00,5,5000.00,33250.00,26750.00,'20221117','202211170004',0,0.00,6500.00,202206160004,1,0),(5,0.00,5,5000.00,9215.00,6715.00,'20221117','202211170005',0,0.00,7500.00,202206160004,1,0),(6,15000.00,5,500.00,22800.00,8300.00,'November-20-2022|01:07:45','202211200006',0,0.00,0.00,202206160007,1,0),(7,4500.00,5,500.00,8360.00,4360.00,'2022-11-20','202211200007',0,0.00,0.00,202206160007,1,0);
...
/*Table structure for table `vwctransaction1` */

DROP TABLE IF EXISTS `vwctransaction1`;

/*!50001 DROP VIEW IF EXISTS `vwctransaction1` */;
/*!50001 DROP TABLE IF EXISTS `vwctransaction1` */;

/*!50001 CREATE TABLE  `vwctransaction1`(
 `transNo` varchar(50) ,
 `clientId` bigint(15) ,
 `clientname` varchar(512) ,
 `noi` int(12) ,
 ...
 `tDate` varchar(50) ,
 `chequeNo` bigint(20) ,
 `chequeamount` double(10,2) ,
 `credamount` double(10,2) 
)*/;

/*Table structure for table `vwctransaction2` */

DROP TABLE IF EXISTS `vwctransaction2`;

/*!50001 DROP VIEW IF EXISTS `vwctransaction2` */;
/*!50001 DROP TABLE IF EXISTS `vwctransaction2` */;

/*!50001 CREATE TABLE  `vwctransaction2`(
 `transNo` varchar(50) ,
 `clientId` bigint(15) ,
 `clientname` varchar(512) ,
...
/*View structure for view vwctransaction1 */

/*!50001 DROP TABLE IF EXISTS `vwctransaction1` */;
/*!50001 DROP VIEW IF EXISTS `vwctransaction1` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vwctransaction1` AS select `td`.`transNo` AS `transNo`,`td`.`clientid` AS `clientId`,concat(`c`.`lname`,', ',`c`.`fname`) AS `clientname`,`td`.`noi` AS `noi`,`td`.`amountTendered` AS `amountTendered`,`td`.`Discount` AS `Discount`,`td`.`delfee` AS `Delfee`,`td`.`totaDueAmount` AS `totaDueAmount`,`td`.`amountChange` AS `amountChange`,`td`.`tDate` AS `tDate`,`td`.`chequeNo` AS `chequeNo`,`td`.`chequeamount` AS `chequeamount`,`td`.`credamount` AS `credamount` from (`transaction_details` `td` join `client` `c` on(`td`.`clientid` = `c`.`Iddetails`)) */;

/*View structure for view vwctransaction2 */

/*!50001 DROP TABLE IF EXISTS `vwctransaction2` */;
/*!50001 DROP VIEW IF EXISTS `vwctransaction2` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vwctransaction2` AS select `td`.`transNo` AS `transNo`,`td`.`clientid` AS `clientId`,concat(`c`.`lname`,', ',`c`.`fname`) AS `clientname`,`td`.`numberofitems` AS `numberofitems`,`td`.`amountTendered` AS `amountTendered`,`td`.`Discount` AS `Discount`,`td`.`delfee` AS `Delfee`,`td`.`totaDueAmount` AS `totaDueAmount`,`td`.`currentBal` AS `currentBal`,`td`.`tDate` AS `tDate`,`td`.`chequeNo` AS `chequeNo`,`td`.`chequeamount` AS `chequeamount`,`td`.`credamount` AS `credamount`,`td`.`isPaid` AS `isPaid` from (`transaction_details2` `td` join `client` `c` on(`td`.`clientid` = `c`.`Iddetails`)) */;
